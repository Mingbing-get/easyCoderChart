...
import { radarValueFields } from './config'

import RadarChart, { RadarChartProps } from '.'

const radarChartMeta: EasyCoderElement.Desc<RadarChartProps> = {
  type: 'chart_radarChart',
  label: {
    zh: '雷达图',
    en: 'Radar chart',
  },
