...
import { funnelValueFields } from './config'

import FunnelChart, { FunnelChartProps } from '.'

const funnelChartMeta: EasyCoderElement.Desc<FunnelChartProps> = {
  type: 'chart_funnelChart',
  label: {
    zh: '漏斗图',
    en: 'Funnel chart',
  },
...
export default funnelChartMeta
